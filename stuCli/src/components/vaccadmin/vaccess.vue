        ...
        <el-card>
                ...
                <el-col :span="3">
                    <el-dropdown split-button type="primary" @command="handleCommand">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item command="1">名称搜索</el-dropdown-item>
                            <el-dropdown-item command="2">疫苗编号</el-dropdown-item>
                            <el-dropdown-item command="3">管理员id</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </el-col>
                <el-col :span="8">
                    <!-- 搜索添加 -->
                    <el-input placeholder="请输入数据" v-model="queryInfo.query" clearable @clear="getVaccList">
                        <el-button slot="append" icon="el-icon-search" @click="getdataformname"></el-button>
                    </el-input>
                </el-col>
                <el-col :span="2">
                    <el-button  type="success" round @click="openaddshow">新增信息</el-button>
                </el-col>
            </el-row>
            <div>
                <!-- 详情信息-->
           ...
           <!-- 疫苗列表 -->
            <el-table :data="vacclist" border stripe height="500px">
                <el-table-column label="疫苗编号:"   width="120px" prop="vaccid">
                    <template slot-scope="scope">
                        <el-button type="text" @click="getvaccdataofvaccid(scope.row.vaccid)">{{scope.row.vaccid}}</el-button>
                    </template>
                </el-table-column>
                <el-table-column label="疫苗名称:" width="120px" prop="name"></el-table-column>
                <el-table-column label="冷库:" width="80px" prop="coldroomid"></el-table-column>
                <el-table-column label="生产日期:" width="120px"  prop="data1"></el-table-column>
                <el-table-column label="保质期:"  width="100px"  prop="data2"></el-table-column>
                <el-table-column label="生产厂家:" width="120px" prop="shop"></el-table-column>
                <el-table-column label="入库时间:" width="120px" prop="intoroomtime"></el-table-column>
                <el-table-column label="出库状态"  width="120px"  prop="isadmin">
                    <template slot-scope="scope">
                        <el-switch v-model="scope.row.isout" @change=""  size="mini" active-color="green"></el-switch>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="管理员id" width="90px" prop="rootid"></el-table-column>
            </el-table>
            <!-- 分页 -->
            <el-pagination
    ...
    export default {
        data() {
            return {
                ...
                addFormRules:{
                    name:[
                        { required: true, message: "疫苗名称", trigger: "blur" },
                    ...
                    rootid:[
                        { required: true, message: "填写疫苗管理员id", trigger: "blur" },
        ...
        methods: {
            ...
            async getVaccList() {
                // 调用post请求
                const { data: res } = await this.$http.post("api/vacc/getAllvacc",this.queryInfo);
